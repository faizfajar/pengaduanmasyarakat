			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="card">
						...
						<div class="card-body">
							<form action="{{route('kirim.tanggapan')}}" method="POST" novalidate>
								@csrf
								<input type="hidden" name="pengaduan_id" value="{{$entri->id}}">
								<input type="hidden" name="petugas_id" value="{{Auth::user()->id}}">
								<div class="md-form">
						            <textarea name="isi_tanggapan" id="textarea-char-counter" class="md-textarea" rows="3" length="300" required></textarea>
					            </div>
